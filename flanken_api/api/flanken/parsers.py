...
curation_germline_arguments.add_argument('TAG' , type=str, required=True, help="")
curation_germline_arguments.add_argument('NOTES', type=str, required=True, help="")
curation_germline_arguments.add_argument('GENE', type=str, required=True, help="")
curation_germline_arguments.add_argument('IMPACT', type=str, required=True, help="")
curation_germline_arguments.add_argument('CONSEQUENCE', type=str, required=True, help="")
curation_germline_arguments.add_argument('HGVSp', type=str, required=True, help="")
curation_germline_arguments.add_argument('N_DP', type=str, required=True, help="")
curation_germline_arguments.add_argument('N_ALT', type=str, required=True, help="")
curation_germline_arguments.add_argument('N_VAF', type=str, required=True, help="")
curation_germline_arguments.add_argument('CLIN_SIG', type=str, required=True, help="")
curation_germline_arguments.add_argument('gnomAD', type=str, required=True, help="")
curation_germline_arguments.add_argument('BRCAEx' , type=str, required=True, help="")
curation_germline_arguments.add_argument('OncoKB' , type=str, required=True, help="")
...
curation_somatic_arguments.add_argument('Chromosome', type=str, required=True, help="")
...
curation_somatic_arguments.add_argument('Reference', type=str, required=True, help="")
curation_somatic_arguments.add_argument('Variant', type=str, required=True, help="")
curation_somatic_arguments.add_argument('Call', type=str, required=True, help="")
curation_somatic_arguments.add_argument('Tags' , type=str, required=True, help="")
curation_somatic_arguments.add_argument('Notes', type=str, required=True, help="")
curation_somatic_arguments.add_argument('GENE', type=str, required=True, help="")
curation_somatic_arguments.add_argument('IMPACT', type=str, required=True, help="")
curation_somatic_arguments.add_argument('CONSEQUENCE', type=str, required=True, help="")
curation_somatic_arguments.add_argument('HGVSp', type=str, required=True, help="")
curation_somatic_arguments.add_argument('T_DP', type=str, required=True, help="")
curation_somatic_arguments.add_argument('T_ALT', type=str, required=True, help="")
curation_somatic_arguments.add_argument('T_VAF', type=str, required=True, help="")
curation_somatic_arguments.add_argument('N_DP', type=str, required=True, help="")
curation_somatic_arguments.add_argument('N_ALT', type=str, required=True, help="")
curation_somatic_arguments.add_argument('N_VAF', type=str, required=True, help="")
curation_somatic_arguments.add_argument('CLIN_SIG', type=str, required=True, help="")
curation_somatic_arguments.add_argument('gnomAD', type=str, required=True, help="")
curation_somatic_arguments.add_argument('BRCAEx' , type=str, required=True, help="")
curation_somatic_arguments.add_argument('OncoKB' , type=str, required=True, help="")
...
curation_svs_arguments.add_argument('SVTYPE' , type=str, required=True, help="")
curation_svs_arguments.add_argument('SV_LENGTH', type=str, required=True, help="")
curation_svs_arguments.add_argument('SUPPORT_READS', type=str, required=True, help="")
curation_svs_arguments.add_argument('TOOL', type=str, required=True, help="")
curation_svs_arguments.add_argument('SAMPLE', type=str, required=True, help="")
curation_svs_arguments.add_argument('GENE_A', type=str, required=True, help="")
curation_svs_arguments.add_argument('IN_DESIGN_A', type=str, required=True, help="")
curation_svs_arguments.add_argument('GENE_B', type=str, required=True, help="")
curation_svs_arguments.add_argument('IN_DESIGN_B', type=str, required=True, help="")
curation_svs_arguments.add_argument('GENE_A-GENE_B-sorted', type=str, required=True, help="")
curation_svs_arguments.add_argument('CALL', type=str, required=True, help="")
curation_svs_arguments.add_argument('TYPE' , type=str, required=True, help="")
curation_svs_arguments.add_argument('SECONDHIT' , type=str, required=True, help="")
curation_svs_arguments.add_argument('COMMENT' , type=str, required=True, help="")
